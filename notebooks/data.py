...
from constants import COL_SMILES, COL_TARGET, DATA_SCHEMA, RANDOM_STATE, DATA_TRAIN_FILENAME, DATA_VALID_FILENAME, DATA_TEST_FILENAME
...
from constants import COL_ID, COL_SMILES, COL_TARGET, DATA_SCHEMA, DATA_SCHEMA_PREDICTION
